...
export const routes: Routes = [
  ...
  { path: 'simple-dashboard', component: DashboardComponent },
  {
    path: '',
    ...
    children: [
      ...
      { path: 'smart-irrigation', component: SmartIrrigationComponent, canActivate: [RoleGuard], data: { role: 'farmer' } },
      { path: 'pump-monitoring', component: PumpMonitoringComponent }
    ]
  }
];
